...
keywords = ["@keyword" + str(i+1) + "@" for i in range(0,101,10)] + ["@keyword" + str(i+1) + "@" for i in range(200,1001,100)] + ["@keyword" + str(i+1) + "@" for i in range(2000,18001,1000)]  # Keyword ID : total 11 keywords
