...
if __name__ == "__main__":
    # measure the performance gap between prf_F and prf_Fp
    ...
    ts = time.time()
    r = prf_Fp(K1,("@keyword1@"+str(1)).encode(),p,g)
    print(r)
    print("Time for prf_Fp is : " + str(time.time()-ts) )

    ts = time.time()
    r = prf_F(K1,("@keyword1@"+str(1)).encode())
    print(r)
    print("Time for prf_F is : " + str(time.time()-ts) )