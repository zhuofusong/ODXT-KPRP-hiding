import sys
from util.HDXClient import HDXTClientV2
import time
...
if __name__ == "__main__":
    ...
    client_obj = HDXTClientV2((HOST, PORT))
    t = time.time()
    client_obj.Setup(100, keywords_file="test/keywords.txt", ids_file="test/ids.txt")
